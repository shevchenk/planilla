...
@section('include')
    ...
    @include( 'mantenimiento.respuesta.js.respuesta_ajax' )
    @include( 'mantenimiento.respuesta.js.respuesta' )
                        ...
                        <table id="TableRespuesta" class="table table-bordered table-hover">
                            <thead>
                                <tr class="cabecera">
                                    ...
                                    <th class="col-xs-2">
                                        <div class="form-group">
                                            <label><h4>Tipo de Respuesta:</h4></label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-search"></i></div>
...
@section('form')
     @include( 'mantenimiento.respuesta.form.respuesta' )
@stop
