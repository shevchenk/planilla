...
CREATE TABLE `m_cursos_carreras` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `persona_id_updated_at` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `mce_curso_id_idx` (`curso_id`) USING BTREE,
  KEY `mce_carrera_id_idx` (`carrera_id`) USING BTREE,
  CONSTRAINT `m_cursos_carreras_ibfk_1` FOREIGN KEY (`curso_id`) REFERENCES `m_cursos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `m_cursos_carreras_ibfk_2` FOREIGN KEY (`carrera_id`) REFERENCES `m_carreras` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;
