...
//                            ));
        ...
        $asistencia->asistencia_id =$r->id;
        $asistencia->persona_contrato_id =$r->persona_contrato_id;
        $asistencia->horario_programado_id =$r->horario_programado_id ;
        $asistencia->fecha_ingreso =$r->fecha_ingreso;
        $asistencia->fecha_salida = $r->fecha_salida;
        $asistencia->hora_ingreso =$r->hora_ingreso ;
        $asistencia->hora_salida = $r->hora_salida;
        $asistencia->total_hora_tardanza = $r->total_hora_tardanza;
        $asistencia->total_hora = $r->total_hora;
        $asistencia->asistencia_estado_ini =$r->asistencia_estado_ini;
        $asistencia->asistencia_estado_fin =$r->asistencia_estado_fin;
        $asistencia->estado = $r->estado;
